import { getSummaryDetailAction } from '@/actions/summary-actions';
...
// this is a dynamic route page som we gotta await for the parameters. To do that we gotta make this function an async one
export default async function SummaryPage(props: {
  params: Promise<{ id: string }>;
}) {
  const { id } = await props.params;

  const summary = await getSummaryDetailAction(id);
